...
- [X] T032 Run the targeted manual validation from `specs/001-media-browser/quickstart.md`
- [X] T033 Verify the existing FileManager and current chat image flows still work after the shared browser-shell extraction
